...
class TestSearchAndVerifyFilter(softest.TestCase):
    ...
    # @data(*Utils.read_data_from_excel("C:\\Users\\Jyothibabu\\PycharmProjects\\PytestFramework\\testdata\\tdataexcel.xlsx","Sheet1"))
    # @data(*Utils.read_data_from_csv("C:\\Users\\Jyothibabu\\PycharmProjects\\PytestFramework\\testdata\\tdatacsv.csv"))
    # @unpack
